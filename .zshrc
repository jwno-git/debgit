...
# Aliases
alias ff="fastfetch --logo-type sixel --logo "/$HOME/Pictures/Logos/debianlogob.png" --logo-padding-left 2 --logo-padding-right 2 --logo-padding-top 1 --color-keys magenta --title-color-user 36 --title-color-host magenta"
alias hyp="Hyprland"
